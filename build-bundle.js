...
const TARGET_ENTRIES = [
    {
        target: "node16",
        entryPoints: ["resources/test-ts-resource/server/server.ts"],
        platform: "node",
        outfile: "resources/test-ts-resource/dist/server/server.js",
    },
    {
        target: "es2020",
        entryPoints: ["resources/test-ts-resource/client/client.ts"],
        outfile: "resources/test-ts-resource/dist/client/client.js",
    },
];
