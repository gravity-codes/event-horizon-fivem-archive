...
function openGui(sentLength, taskID, namesent, chancesent, skillGapSent)
    ...
    SendNUIMessage({ runProgress = true,
        Length = sentLength,
        Task = taskID,
        name = namesent,
        chance = chancesent,
...
RegisterNetEvent('factor:restore', function()
    Wait(15000)
    FactorFunction(true)
end)

--- Begins a taskbar for the player.
--- @param difficulty any
--- @param skillGapSent any
--- @return boolean
